...
- **Statistiques Système** : Intégration optionnelle pour récupérer le CPU, la RAM, le Stockage et l'état du certificat SSL via une API de status sécurisée.
...
---
*Projet réalisé en TypeScript avec Drizzle ORM et Discord.js v14.*
